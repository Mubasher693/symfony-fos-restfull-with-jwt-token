 ...
 */
final class Version20211222124926 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__post AS SELECT id, title, description FROM post');
        ...
        $this->addSql('INSERT INTO post (id, title, description) SELECT id, title, description FROM __temp__post');
